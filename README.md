...
Чтобы скачать проект, необходимо выполнить следующие шаги:
...
└── src
    ...
    └── main.cpp
```
В директории src/ хранятся исходные файлы проекта. 
В директории build/ хранятся результаты сборки проекта.
